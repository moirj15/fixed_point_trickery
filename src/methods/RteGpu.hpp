...
class RteGpuMethod final
{
  const std::string VERT_PATH  = "shaders/RteGpu.hlsl";
  const std::string PIXEL_PATH = "shaders/RteGpu.hlsl";
...
public:
  explicit RteGpuMethod(ID3D11Device3 *device, ShaderWatcher &shaderWatcher);
